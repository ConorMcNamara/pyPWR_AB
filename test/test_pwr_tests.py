...
class TestAB_T2n:
    ...
    def test_power_results() -> None:
        power_results = pwr_tests.ab_t2n(n=3000, percent_b=0.3, mean_diff=0.15, sd_a=1, sd_b=2, sig_level=0.05,
        ...
        mean_diff_results = pwr_tests.ab_t2n(n=3_000, percent_b=0.3, sd_a=1, sd_b=2, sig_level=0.05, power=0.8,
                                             alternative="less")["mean_diff"]
        ...
        sig_level_results = pwr_tests.ab_t2n(n=1500, percent_b=0.3, mean_diff=0.3, sd_a=1, sd_b=2, power=0.8,
                                             alternative='greater')["sig_level"]
        ...
        percent_b_results = \
            pwr_tests.ab_t2n(n=1500, mean_diff=0.3, sd_a=1, sd_b=2, sig_level=0.10, power=.8, alternative='two-sided')[
                "percent_b"]
...
class TestABProp_T2n:
    ...
    @staticmethod
    def test_power_results() -> None:
        power_results = pwr_tests.ab_t2n_prop(prop_a=0.2, prop_b=0.25, n=3_000, percent_b=0.3,
                                              sig_level=0.05, alternative='two-sided')["power"]
        ...
        n_results = pwr_tests.ab_t2n_prop(prop_a=0.8, prop_b=0.5, n=None, percent_b=0.3, power=0.8, sig_level=0.05,
                                          alternative='less')["n"]
        ...
        percent_b_results = pwr_tests.ab_t2n_prop(prop_a=0.4, prop_b=0.8, n=500, percent_b=None, power=0.8,
                                                  sig_level=0.05, alternative='greater')["percent_b"]
